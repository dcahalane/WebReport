...
Ext.ux.Exporter.ExcelFormatter.Worksheet = Ext.extend(Object, {
  ...
  buildColumn: function(width) {
    return String.format('<ss:Column ss:AutoFitWidth="1" ss:Width="{0}" />\n', width || 164);
  },
  ...
  buildHeader: function() {
    ...
    Ext.each(this.columns, function(col) {
      ...
      cells.push(String.format('<ss:Cell ss:StyleID="headercell"><ss:Data ss:Type="String">{0}</ss:Data><ss:NamedCell ss:Name="Print_Titles" /></ss:Cell>\n', title));
    }, this);
