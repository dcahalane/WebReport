 ...
 */
/**
 * @class Ext.MessageBox2
 * <p>Utility class for generating different styles of message boxes.  The alias Ext.Msg can also be used.<p/>
 * <p>Note that the MessageBox2 is asynchronous.  Unlike a regular JavaScript <code>alert</code> (which will halt
 * browser execution), showing a MessageBox2 will not cause the code to stop.  For this reason, if you have code
 * that should only run <em>after</em> some user feedback from the MessageBox2, you must use a callback function
...
Ext.MessageBox2 = function(){
    ...
    var updateButtons = function(b){
        ...
        Ext.iterate(buttons, function(name, btn){
            ...
            if(cfg){
                btn.show();
                btn.setText(Ext.isString(cfg) ? cfg : Ext.MessageBox2.buttonText[name]);
    ...
    return {
         ...
         * initiated via {@link Ext.MessageBox2#progress} or {@link Ext.MessageBox2#wait},
         * or by calling {@link Ext.MessageBox2#show} with progress: true.
         ...
         * passed in. All display functions (e.g. prompt, alert, etc.) on MessageBox2 call this function internally,
         ...
         * <li><b>buttons</b> : Object/Boolean<div class="sub-desc">A button config object (e.g., Ext.MessageBox2.OKCANCEL or {ok:'Foo',
         ...
         * <li><tt>cancel</tt></li>
         * </ul></div></div></li>
         * <li><b>text</b> : String<div class="sub-desc">Value of the input field if either <tt><a href="#show-option-prompt" ext:member="show-option-prompt" ext:cls="Ext.MessageBox2">prompt</a></tt>
         * or <tt><a href="#show-option-multiline" ext:member="show-option-multiline" ext:cls="Ext.MessageBox2">multiline</a></tt> is true</div></li>
         ...
         * dialog (e.g. Ext.MessageBox2.WARNING or 'custom-class') (defaults to '')</div></li>
...
Ext.Msg.show({
   ...
   width: 300,
   buttons: Ext.MessageBox2.OKCANCEL,
   multiline: true,
   fn: saveAddress,
   animEl: 'addAddressBtn',
   icon: Ext.MessageBox2.INFO
});
</code></pre>
         * @return {Ext.MessageBox2} this
         */
         ...
         * to clear any existing icon. This method must be called before the MessageBox2 is shown.
         * The following built-in icon classes are supported, but you can also pass in a custom class name:
         * <pre>
Ext.MessageBox2.INFO
Ext.MessageBox2.WARNING
Ext.MessageBox2.QUESTION
Ext.MessageBox2.ERROR
         *</pre>
         ...
         * the user.  You are responsible for updating the progress bar as needed via {@link Ext.MessageBox2#updateProgress}
         ...
         * Customize the default text like so: Ext.MessageBox2.buttonText.yes = "oui"; //french
         * @type Object
         */
        buttonText : {
            ok : "OK",
...
/**
 * Shorthand for {@link Ext.MessageBox2}
 */
Ext.Msg2 = Ext.MessageBox2;